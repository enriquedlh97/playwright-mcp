## Playwright MCP
[![smithery badge](https://smithery.ai/badge/@enriquedlh97/mit-playwright-mcp)](https://smithery.ai/server/@enriquedlh97/mit-playwright-mcp)
...
To install mit-playwright-mcp automatically via [Smithery](https://smithery.ai/server/@enriquedlh97/mit-playwright-mcp):

```bash
npx -y @smithery/cli install @enriquedlh97/mit-playwright-mcp
```
